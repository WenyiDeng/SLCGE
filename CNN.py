...
if __name__ == "__main__":
    ...
    x = np.loadtxt('dataset/data.txt')
    y = np.loadtxt('dataset/label.txt')
    ...
    print("5 fold auc :", test_auc)
    print("5 fold mean auroc {:.5f}".format(np.mean(test_auc)))
    print("5 fold mean aupr {:.5f}".format(np.mean(test_pr)))